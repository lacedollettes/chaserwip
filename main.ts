...
sprites.onOverlap(SpriteKind.Player, SpriteKind.Projectile, function (sprite, otherSprite) {
    ...
    if (true) {
        ...
        mySprite3.setPosition(5, 55)
        mySprite3.follow(player1)
    }
    if (info.life() == 0) {
        music.play(music.stringPlayable("C D E F E D C C ", 246), music.PlaybackMode.UntilDone)
        game.gameOver(false)
    }
})
function setup () {
